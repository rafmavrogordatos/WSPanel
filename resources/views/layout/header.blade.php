  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
    ...
    <ul class="navbar-nav navbar-nav-left header-links">
      <li class="nav-item d-none d-xl-flex">
        <a href="#" class="nav-link"><span class="badge badge-primary ml-1">0</span>&nbsp;Pending Orders
        </a>
      </li>
      <li class="nav-item active d-none d-lg-flex">
        <a href="#" class="nav-link">
          <i class="mdi mdi-cash"></i><span class="badge badge-primary ml-1">0</span>&nbsp;Overdue Invoices</a>
      </li>
      <li class="nav-item d-none d-md-flex">
        <a href="#" class="nav-link">
          <i class="mdi mdi-note"></i><span class="badge badge-primary ml-1">0</span>&nbsp;Tickets Awaiting Reply</a>
      </li>
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item dropdown d-none d-xl-inline-block">
        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          <span class="profile-text d-none d-md-inline-flex">Rafail Mavrogordatos</span>
